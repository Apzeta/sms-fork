...
function banner(){
echo -e ${BLUE}"##########################################################"                                                    
echo -e ${RED}"     _____     _             ____  __  __ ____            #"    
echo -e ${RED}"    |  ___|_ _| | _____     / ___||  \/  / ___|           #"
echo -e ${RED}"    | |_ / _  | |/ / _ \____\___ \| |\/| \___ \           #"
echo -e ${RED}"    |  _| (_| |   <  __/_____|__) | |  | |___) |          #"
echo -e ${RED}"    |_|  \__,_|_|\_\___|    |____/|_|  |_|____/           #"
echo -e ${BLUE}"                                                         #"
echo -e ${BLUE}"      A Small Tool To Send Messages Anonymously          #"
echo -e ${RED}"   WARNING: Use this Tool Only For Educational Purpose    #"
echo -e ${BLUE}"             I Will Not Be Responsible For Your Box      #"
echo -e ${BLUE}"            Coded By: Machine404                         #"
echo -e ${BLUE}"            Forkd By: Apzeta            		 #"
echo -e ${RED}" Github https://github.com/machine1337/fake-sms           #"
echo -e ${RED}" Github https://github.com/Apzeta/sms-fork"
echo -e ${BLUE}"##########################################################"
...
function SENDSMS() {
   ...
   echo -e -n ${RED}"Enter Phone Number With Country Code: "
